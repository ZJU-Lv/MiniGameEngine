...
void ExampleLayer::OnUpdate(MGE::Timestep ts)
{
	// Update
	...
	m_Texture->Bind();
	MGE::Renderer::Submit(textureShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));
...
void ExampleLayer::OnEvent(MGE::Event& e)
{
